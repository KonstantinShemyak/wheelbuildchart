$(document).ready(function() {
	...
	$toleranceInput.on('change', updateCalculations);
	...
	function updateCalculations() {
		...
		var tolerance = parseFloat($toleranceInput.val());
		var minTensions = [avgTensions[0] * ((100 - tolerance) / 100), avgTensions[1] * ((100 - tolerance) / 100)];
		var maxTensions = [avgTensions[0] * ((100 + tolerance) / 100), avgTensions[1] * ((100 + tolerance) / 100)];
